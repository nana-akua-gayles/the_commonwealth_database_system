...
<body>
    ...
    <div class="popup" id="popup">
        ...
        <div class="pDetails" style="margin-bottom:40%; padding:15px;">
            <p><strong>Name:</strong> General Admin</p>
            <p><strong>Username:</strong> GENERALADMIN</p>
            <p><strong>Email:</strong> generaladmin@gmail.com</p>
    ...
    document.addEventListener('click', function(event) {
        if (popup.style.display === 'block' && !popup.contains(event.target) && !profilePhoto.contains(event.target)) {
